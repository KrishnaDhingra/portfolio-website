export let buttons_data = [
    ...
    {
        innerHTML: 'E-commerce'

    },
    {
        innerHTML: 'Single Page'

    },
    {
        innerHTML: 'Multi Page'

    },
    {
        innerHTML: 'Mini Projects'
...
export let project_data = [
    {
        ...
        description: 'lorem ispum dolorer amaset pondes la bolor la in the hello',
        technologies_used: ['JSX', 'REACT', 'REACT ROUTER', 'CSS']
    },
    {
        show: true,
    ...
    },
    {
        ...
        description: 'lorem ispum dolorer amaset pondes la bolor la in the hello',
        technologies_used: ['JSX', 'REACT', 'REACT ROUTER', 'CSS', 'STYLED COMP']
    },
    {
        show: true,
        category: 'multi page',
    ...
    },
    {
        ...
        description: 'lorem ispum dolorer amaset pondes la bolor la in the hello',
        technologies_used: ['JSX', 'CSS3', 'REACT', 'STYLED COMP']
    },
    {
        show: true,
        category: 'single page',
        image: 'https://res.cloudinary.com/dz209s6jk/image/upload/q_auto,w_700/Challenges/elfkzwrvlhcxvoy9442f.jpg',
        description: 'lorem ispum dolorer amaset pondes la bolor la in the hello',
        technologies_used: ['JSX', 'CSS3', 'REACT', 'STYLED COMP']
    }
